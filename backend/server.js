...
// 🔥🔥🔥 [소리 전용] 아두이노 COM14 연결 설정 🔥🔥🔥
let soundSerial = null;
try {
    soundSerial = new SerialPort({
        path: 'COM14', // 소리 전용 아두이노 포트
        baudRate: 9600
    });
    ...
    console.log('⚠️ COM14 port not found. Sound disabled.');
}
